...
import ReviewSliderItem from "@/ui/reviews/review-slider/ReviewSliderItems/ReviewSliderItem";

const ReviewSliderItems:FC<{ items: ISliderItem[] }> = ({items}) => {
            ...
            <div className={styles.sliderList} ref={slider}>
                <div className={styles.sliderItems} ref={sliderTrackRef}>
                    {items && items.map(item => (
                        <ReviewSliderItem key={item.id} item={item}/>
                    ))}
                </div>
            </div>
