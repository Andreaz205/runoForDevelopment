...
import CatalogSliderItem from "@/ui/catalog-slider/CatalogSliderItems/CatalogSliderItem";

const MemorizedCatalogSliderItem = React.memo(CatalogSliderItem)

const CatalogSliderItems:FC<{ items: ISliderItem[] }> = ({items}) => {
            ...
            <div className={styles.sliderList} ref={slider}>
                <div className={styles.sliderItems} ref={sliderTrackRef}>
                    {items && items.map(item => (
                        <MemorizedCatalogSliderItem key={item.id} item={item}/>
                    ))}
                </div>
            </div>
...
export default CatalogSliderItems;